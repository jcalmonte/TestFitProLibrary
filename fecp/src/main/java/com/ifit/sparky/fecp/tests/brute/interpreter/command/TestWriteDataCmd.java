...
public class TestWriteDataCmd extends TestCase {
     ...
     * @throws Exception
     */
    public void testWriteDataCmd_CopyConstructor() throws Exception{

        //check all the different options for generating the buffer
        WriteDataCmd cmd;
        WriteDataCmd copyCmd;
