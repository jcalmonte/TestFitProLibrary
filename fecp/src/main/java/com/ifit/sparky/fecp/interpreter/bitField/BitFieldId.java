...
public enum BitFieldId {
    ...
    GRADE(1, 2, false, new InclineConverter(), "Incline"),
    ...
    MAX_GRADE(27, 2, true, new InclineConverter(), "Max Incline"),
    MIN_GRADE(28, 2, true, new InclineConverter(), "Min Incline"),
    ...
    AVERAGE_GRADE(52, 2, true, new InclineConverter(), "Average Grade"),
    WT_MAX_GRADE(53, 2, true, new InclineConverter(), "Max Grade"),
    ...
    GRADE_GOAL(59, 2, false, new InclineConverter(), "Grade Goal"),
